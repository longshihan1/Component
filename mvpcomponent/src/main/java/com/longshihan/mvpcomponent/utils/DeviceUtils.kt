...
object DeviceUtils {
    ...
    var GTE_HC: Boolean = Build.VERSION.SDK_INT >= 11
    var GTE_ICS: Boolean = Build.VERSION.SDK_INT >= 14
    var PRE_HC: Boolean =  Build.VERSION.SDK_INT < 11;
    ...
    fun getDefaultLoadFactor(context: Context): Int {
        if (_loadFactor == null) {
            val integer = Integer.valueOf(0xf and context.resources.configuration.screenLayout)
            _loadFactor = integer
